...
export type MutationCreateNewLandArgs = {
  data: LangInput;
};
...
export type FullreposQuery = { __typename?: 'Query', fullrepos: Array<{ __typename?: 'Repo', id: string, name: string, url: string, isFavorite: boolean, status: { __typename?: 'Status', label: string }, langs: Array<{ __typename?: 'Lang', label: string }> }> };
